...
- ✓ Терминал: топ по росту/падению за день — Phase 5
- ✓ Корреляционная матрица позиций — Phase 6 + 6.1 (configurable period)
- ✓ Секторная аллокация портфеля — Phase 6
- ✓ Analytics Data Quality: concentration index, IMOEX benchmark, dividend yield, instrument P&L — Phase 6.1
...
- **TopMover type:** уже объявлен в core/types/terminal.ts, компонент реализован (Phase 5)
...
---
*Last updated: 2026-03-26 after Phase 5 completion*
