...
export const StrategyForm = ({ mode, strategy, onClose, onSuccess }: StrategyFormProps) => {
        ...
        <TabsContent value="general" className="mt-4 space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select
                defaultValue={strategy?.instrumentType ?? "STOCK"}
            ...
            <div className="space-y-2">
              ...
              <Select
                defaultValue={strategy?.timeframe ?? "1d"}
