...
import { getCandlesForChartAction, getTradeMarkersAction, getDailySessionStatsAction, type ChartMarker } from "@/server/actions/chart-actions"
import type { DailySessionStats } from "@/server/services/session-stats"
...
export default function TerminalPage() {
  ...
  const handleQuickSelect = useCallback(async (t: string) => {
    ...
    if (res.success && res.data) {
      handleInstrumentSelect(res.data)
    }
